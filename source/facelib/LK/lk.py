...
class GroupTrack():
    ...
    def __init__(self):
        ...
        self.thres =1  # cfg.TRACE.pixel_thres  # config.TRACE.pixel_thres = 1
        self.alpha =0.95 # cfg.TRACE.smooth_landmark   # config.TRACE.smooth_landmark = 0.95
        self.iou_thres =0.45 # cfg.TRACE.iou_thres  # config.TRACE.iou_thres = 0.5
